...
namespace MassTransit.AutofacIntegration
{
    public static class StateMachineSagaConfiguratorCache
    {
        ...
        public static void Configure(Type sagaType, IReceiveEndpointConfigurator configurator, ILifetimeScope scope,
            string name)
        {
        ...
        private interface CachedConfigurator
        {
            void Configure(IReceiveEndpointConfigurator configurator, ILifetimeScope scope, string name);
        }

        private class CachedConfigurator<T> : CachedConfigurator where T : class, SagaStateMachineInstance
        {
